...
const Contact = props => {
  return (
    <div>
    <div id="Contact" className="sectionTitle">Contact</div>
    <div className='contactList'>
      <ul>
        <a href="mailto:benjamin.r.sullivan@gmail.com"><li>
        ...
        <a href="https://github.com/Goto15"><li>
        ...
        <a href="https://www.linkedin.com/in/bensullivan015/"><li>
